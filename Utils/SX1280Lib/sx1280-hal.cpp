...
void SX1280Hal::SpiInit( void )
{
    ...
    printf("Spi Speed set at : 8000000\r\n");
#else
    this->SetSpiSpeed( 2000000 );
    printf("Spi Speed set at : 2000000\r\n");
#endif
    wait( 0.1 );
}
...
void SX1280Hal::IoIrqInit( DioIrqHandler irqHandler )
{
    ...
    BUSY.mode( PullNone );
    printf("IoIrqInit ... BUSY set :%d (debug)\n\r",PullNone);
    printf("IoIrqInit ... WaitOnBusy Test (debug)\n\r");
    WaitOnBusy();
    printf("IoIrqInit ... Done (debug)\n\r");
...
{
    printf("Wakeup ... __disable_irq\n\r");
    __disable_irq( );
    printf("Wakeup ... Done\n\r");

    //Don't wait for BUSY here
    printf("GetDioStatus : %u\n\r",this->GetDioStatus());
    if( RadioSpi != NULL )
    {
        printf("Wakeup ... RadioSpi writting\n\r");
        RadioNss = 0;
    ...
    if( RadioUart != NULL )
    {
        printf("Wakeup ... RadioUart writting\n\r");
    ...
    printf("Wakeup ... Done\n\r");
    printf("GetDioStatus : %u\n\r",this->GetDioStatus());
    printf("Wakeup ... WaitOnBusy\n\r");
    // Wait for chip to be ready.
    WaitOnBusy( );
    printf("Wakeup ... Done\n\r");
    printf("Wakeup ... __enable_irq\n\r");
