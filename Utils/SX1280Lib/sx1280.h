...
/*!
 * \brief Returns the Spreading Factor enum type corresponding to the given integer code (e.g. 5 for SF5)
 */
inline RadioLoRaSpreadingFactors_t int_to_sf(int sf_code) {
    return (static_cast<RadioLoRaSpreadingFactors_t> (sf_code << 4) );
}
